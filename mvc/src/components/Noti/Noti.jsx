...
const Noti = () => {
	...
	return (
		<div className="Noti">
			<div className="NHeader">Thông Báo</div>

			<div className="Noti-noti n1">
				<div className="ImgContainer">
					<img classname="Noti-image i1" src={Ali}></img>
				</div>
				<div className="TxtContainer">Bạn có tin nhắn từ Ali Ahmad!</div>
				<div className="MarkContainer">
					<img classname="Mark-image i7" src={Unread}></img>
				</div>
				<div className="TimeContainer">15 phút trước</div>
			</div>
			...
			<div className="Noti-noti n2">
				...
				<div className="TimeContainer">20 phút trước</div>
			</div>
			...
			<div className="Noti-noti n3">
				...
				<div className="TxtContainer">Bạn có tin nhắn từ Maria Memon!</div>
				<div className="MarkContainer">
					<img classname="Mark-image i7" src={Unread}></img>
				</div>
				<div className="TimeContainer">31 phút trước</div>
			</div>
			...
			<div className="Noti-noti n4">
				...
				<div className="TimeContainer">40 phút trước</div>
			</div>
			...
			<div className="Noti-noti n5">
				...
				<div className="TimeContainer">45 phút trước</div>
			</div>
			...
			<div className="Noti-noti n6">
				...
				<div className="TimeContainer">47 phút trước</div>
			</div>
			...
			<div className="Noti-noti n7">
				...
				<div className="TimeContainer">1 giờ 10 phút trước</div>
			</div>
		</div>
	);
};
