...
const SettingGeneral = () => {
	...
	return (
		<div className="GeneralSetting">
			<div className="GHeader">General</div>
			<div className="LanguageSetting">
				<div className="GHeader1">Ngôn Ngữ</div>
				<button className="Dropdown" onClick={handleLanguageClick}>
					{message}
				</button>
				{isShown && (
					<div className="Dropdown-list">
						<button
							className="Dropdown-list-item item1"
							onClick={() => {
								handleLangChoose("Tiếng Việt");
							}}
						>
							Tiếng Việt
						</button>
						<button
							className="Dropdown-list-item item2"
							onClick={() => {
								handleLangChoose("English");
							}}
						>
							English
						</button>
			...
			<div className="Logout">
				<div className="GHeader2">Đăng Xuất</div>
